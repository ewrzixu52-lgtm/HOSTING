...
def find_user_by_username(username: str):
    """Resolve '@username' -> target user using the in-memory cache built
    from group messages. Returns None if we haven't seen this username
    (e.g. they never sent a message since the bot last started)."""
