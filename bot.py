...
async def ai_classify_admin_command(command_text: str, has_reply_target: bool, recent_context: str = "") -> dict:
    ...
    system_prompt = (
        ...
        '"permission": null, "enabled": null, "confidence": "high|medium|low"}]}'
    )
...
ACTION_PERMISSION_REQUIREMENT = {
    ...
    "unmute": "can_restrict_members", "warn": "can_restrict_members",
        ...
        if action in ("ban", "unban", "kick", "mute", "unmute", "warn", "unwarn",
            ...
            if action == "ban":
                ...
                await msg.reply_text(
                    ...
                    f"(abhi sirf group me dikhega, koi special power nahi hai).\n\n"
                    f"Extra permissions dene ke liye, number(s) comma se likh do (jaise <code>1,3,5</code>):\n"
                    f"1. Delete messages\n2. Restrict/ban/mute members\n3. Pin messages\n"
                    f"4. Invite users via link\n5. Manage video chats\n6. Change group info\n"
                    f"7. Add new admins (promote others)"),
                    parse_mode=ParseMode.HTML,
                )
