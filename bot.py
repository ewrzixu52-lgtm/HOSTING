...
async def execute_admin_action(context: ContextTypes.DEFAULT_TYPE, update: Update, result: dict, admin_user, command_text: str = ""):
    ...
    if not target and command_text:
        # No reply given -- resolve "@username" from the command text.
        # Ask Telegram directly first (this also works for people who
        # aren't even in the group, e.g. pre-emptive ban by username).
