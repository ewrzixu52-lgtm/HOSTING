...
async def ai_classify_admin_command(command_text: str, has_reply_target: bool, recent_context: str = "") -> dict:
    ...
    system_prompt = (
        ...
        "zyada better banata hai, isliye skip mat karo.\n\n"
        'Respond ONLY with compact JSON: {"reasoning": "...", "actions": '
        '[{"action": "...", "duration_minutes": null, "title": null, "count": 1, "confidence": "high|medium|low"}]}'
    )
...
jaise "iska tag change karo (Manager)").
